Module LabelsToPrint
    Public Function Get_ContentTo_Print(SN As ArrayList, LabelScenario As Integer, x As Integer, y As Integer) As String
        Select Case LabelScenario
            Case 2 '"Этикетки 45х8 "
                Return $"
...
^LL0154
^LS0
^BY2,3,41^FT{ 83 + x },{ 106 + y }^BCN,,N,N
^FD>:{ Mid(SN(1), 1, 2) }>5{ Mid(SN(1), 3) }^FS
^FT{ 76 + x },{ 62 + y }^A0N,29,28^FH\^FDS/N:^FS
^FT{ 129 + x },{ 62 + y }^A0N,29,28^FH\^FD{ SN(1) }^FS
^PQ3,0,1,Y^XZ"
            Case 1 '"Этикетки 45х8 "
                '"Этикетки 39х19" Этикетки 45х8
                Return "
^XA~TA000~JSN^LT0^MNW^MTT^PON^PMN^LH0,0^JMA^JUS^LRN^CI0^XZ
^XA
^MMT
